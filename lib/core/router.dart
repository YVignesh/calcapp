...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    // Calculator
    GoRoute(path: '/calculator', builder: (c, s) => const CalculatorScreen()),
    GoRoute(path: '/scientific', builder: (c, s) => const ScientificScreen()),
    GoRoute(path: '/advanced-math', builder: (c, s) => const AdvancedMathScreen()),
    GoRoute(path: '/graph', builder: (c, s) => const GraphScreen()),
    // Finance
    GoRoute(path: '/compound-interest', builder: (c, s) => const CompoundInterestScreen()),
    GoRoute(path: '/loan', builder: (c, s) => const LoanScreen()),
    GoRoute(path: '/mortgage', builder: (c, s) => const MortgageScreen()),
    ...
    GoRoute(path: '/future-value', builder: (c, s) => const FutureValueScreen()),
    GoRoute(path: '/retirement', builder: (c, s) => const RetirementScreen()),
    GoRoute(path: '/savings-goal', builder: (c, s) => const SavingsGoalScreen()),
    GoRoute(path: '/salary', builder: (c, s) => const SalaryScreen()),
    GoRoute(path: '/pay-raise', builder: (c, s) => const PayRaiseScreen()),
    GoRoute(path: '/credit-card', builder: (c, s) => const CreditCardScreen()),
    GoRoute(path: '/stock-average', builder: (c, s) => const StockAverageScreen()),
    GoRoute(path: '/tip', builder: (c, s) => const TipScreen()),
    GoRoute(path: '/sales-tax', builder: (c, s) => const SalesTaxScreen()),
    GoRoute(path: '/discount', builder: (c, s) => const DiscountScreen()),
    // Units
    GoRoute(
      path: '/units/:type',
      builder: (c, s) => UnitScreen(unitType: s.pathParameters['type']!),
    ),
    // Health
    ...
    GoRoute(path: '/waist-hip', builder: (c, s) => const WaistHipScreen()),
    GoRoute(path: '/pregnancy', builder: (c, s) => const PregnancyScreen()),
    // Cooking
    GoRoute(path: '/cooking', builder: (c, s) => const CookingScreen()),
    GoRoute(path: '/oven-temp', builder: (c, s) => const OvenTempScreen()),
    // Home & Garden
    GoRoute(path: '/square-footage', builder: (c, s) => const SquareFootageScreen()),
    GoRoute(path: '/flooring', builder: (c, s) => const FlooringScreen()),
    GoRoute(path: '/electricity', builder: (c, s) => const ElectricityScreen()),
    GoRoute(path: '/mulch', builder: (c, s) => const MulchScreen()),
    GoRoute(path: '/paint', builder: (c, s) => const PaintScreen()),
    // Math & More
    GoRoute(path: '/percentage', builder: (c, s) => const PercentageScreen()),
    GoRoute(path: '/fraction', builder: (c, s) => const FractionScreen()),
    GoRoute(path: '/statistics', builder: (c, s) => const StatisticsScreen()),
    GoRoute(path: '/quadratic', builder: (c, s) => const QuadraticScreen()),
    GoRoute(path: '/triangle', builder: (c, s) => const TriangleScreen()),
    GoRoute(path: '/age', builder: (c, s) => const AgeScreen()),
    GoRoute(path: '/date-diff', builder: (c, s) => const DateDiffScreen()),
    GoRoute(path: '/grade', builder: (c, s) => const GradeScreen()),
    GoRoute(path: '/roman', builder: (c, s) => const RomanScreen()),
    GoRoute(path: '/base-converter', builder: (c, s) => const BaseConverterScreen()),
  ],
);
