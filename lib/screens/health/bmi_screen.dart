...
class _BmiScreenState extends State<BmiScreen> {
  ...
  Widget build(BuildContext context) {
    return CalcScaffold(
      ...
      description: 'Body Mass Index is a simple weight-to-height ratio. Supports metric (kg/cm) and imperial (lb/in). Not a substitute for medical advice.',
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _unitBtn('Metric (kg/cm)', _isMetric, () => setState(() => _isMetric = true))),
              const SizedBox(width: 10),
              Expanded(child: _unitBtn('Imperial (lb/in)', !_isMetric, () => setState(() => _isMetric = false))),
            ],
          ),
