...
class _MulchScreenState extends State<MulchScreen> {
  ...
  void _calculate() {
    ...
    double depthFt = _depthUnit == 'inches' ? d / 12 : (_depthUnit == 'cm' ? d / 30.48 : d);
  ...
  Widget build(BuildContext context) {
    return CalcScaffold(
      title: 'Mulch & Gravel',
      description: 'Calculate how many cubic yards or cubic meters of mulch, gravel, or soil you need for a garden bed.',
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            children: ['feet', 'meters'].map((u) => ChoiceChip(
              label: Text(u),
          ...
          Wrap(
            spacing: 8,
            children: ['inches', 'cm', 'feet'].map((u) => ChoiceChip(
              label: Text(u),
